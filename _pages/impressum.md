...
Diese Website verwendet keine Cookies und keine Analyse- oder Tracking-Tools. Externe Links auf dieser Website führen zu Drittanbietern, deren Datenschutzbestimmungen wir nicht kontrollieren.
...
3. Hosting
Diese Website wird auf GitHub Pages gehostet. Beim Besuch der Website erfasst GitHub automatisch technische Daten in Server-Logfiles, insbesondere Ihre IP-Adresse, Datum und Uhrzeit des Zugriffs sowie die aufgerufene Seite. Diese Daten werden von GitHub Inc. (88 Colin P Kelly Jr St, San Francisco, CA 94107, USA) verarbeitet. Da GitHub seinen Sitz in den USA hat, kann eine Übertragung personenbezogener Daten in die USA stattfinden. Weitere Informationen finden Sie in der Datenschutzerklärung von GitHub: https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement. Die Nutzung von GitHub Pages erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einer zuverlässigen Bereitstellung der Website).
